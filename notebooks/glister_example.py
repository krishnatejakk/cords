# -*- coding: utf-8 -*-
"""Modular_Training_CRAIG_Strategies_1.ipynb
...
def train_model(num_epochs, dataset_name, datadir, feature, model_name, fraction, select_every, learning_rate, run,
    ...
    print_every = 3
    all_logs_dir = '/content/drive/MyDrive/Results/' + strategy + '/' + dataset_name + '/' + feature + '/' + str(
    ...
    for i in range(num_epochs):
        ...
        if strategy in ['CRAIG', 'CRAIGPB', 'CRAIGPB-Explore', 'CRAIG-Explore', 'GradMatch', 'GradMatch-Explore',
                        'GradMatchPB', 'GradMatchPB-Explore']:
            start_time = time.time()
